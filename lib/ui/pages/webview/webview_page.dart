...
class _WebViewPageState extends State<WebViewPage> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final int settingsIndex = webTitles.length + 2;
      final int currentNavItemCount = webTitles.length + 3;
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: WebViewBottomNavBar(
            ...
            onTap: (int index) {
              ...
              } else if (index - 1 < webTitles.length) {
                // 获取对应的 URL
                String url;
                String title;
                if (index - 1 == 0) {
                  ...
                  title = 'AstrBot';
                } else if (napCatEnabled && index - 1 == 1) {
                  // NapCat
                  ...
                  // 自定义 WebView
                  final customIndex = (index - 1) - (napCatEnabled ? 2 : 1);
